...
using Xunit;
using Verifier =
    Microsoft.CodeAnalysis.CSharp.Testing.XUnit.CodeFixVerifier<Analyzers55.SampleSyntaxAnalyzer,
        Analyzers55.SampleCodeFixProvider>;

namespace Analyzers55.Tests;
